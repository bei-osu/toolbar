        ...
        `;
                ...
                static setupCollabActions(panel) {
                        ...
                        if (chatInput && sendBtn) {
                                [chatInput, sendBtn].forEach(el => el.addEventListener('mousedown', e => e.stopPropagation()));
                                const sendMessage = () => {
...
`;
  ...
  negative: { color: '#fffafa', bg: 'rgba(255,240,240,0.08)', border: 'rgba(255,220,220,0.15)', category: 'negative' },
  awkward: 'negative', uncomfortable: 'negative', clunky: 'negative', forced: 'negative',
  jarring: 'negative', wrong: 'negative', inconsistent: 'negative', bad: 'negative',
  broken: 'negative', messy: 'negative', odd: 'negative', weird: 'negative',
  strange: 'negative', confusing: 'negative', unclear: 'negative', problematic: 'negative',
  unnatural: 'negative', unfitting: 'negative', unsuitable: 'negative', inappropriate: 'negative',
  rough: 'negative', harsh: 'negative', abrupt: 'negative', sudden: 'negative',
  disjointed: 'negative', disconnected: 'negative', misaligned: 'negative', mismatched: 'negative',
  incorrect: 'negative', flawed: 'negative', imperfect: 'negative', empty: 'negative',
  void: 'negative', issue: 'negative', problem: 'negative', unplayable: 'negative',
  unreadable: 'negative', unintuitive: 'negative', unpolished: 'negative', incomplete: 'negative',
  critical: 'negative', unrankable: 'negative', disqualified: 'negative',
  alert: { color: '#fffbf9', bg: 'rgba(255,248,245,0.08)', border: 'rgba(255,235,220,0.15)', category: 'alert' },
  overmapped: 'alert', dense: 'alert', overcharted: 'alert', overloaded: 'alert',
  intense: 'alert', excessive: 'alert', heavy: 'alert', crowded: 'alert',
  packed: 'alert', overwhelming: 'alert', busy: 'alert', cramped: 'alert',
  cluttered: 'alert', congested: 'alert', compressed: 'alert', tight: 'alert',
  inflated: 'alert', exaggerated: 'alert', overdone: 'alert', insane: 'alert',
  expert: 'alert', concern: 'alert', severe: 'alert',
  extreme: 'alert', major: 'alert', required: 'alert', mandatory: 'alert',
  technical: { color: '#fdfaff', bg: 'rgba(250,248,255,0.08)', border: 'rgba(240,235,255,0.15)', category: 'technical' },
  release: 'technical', ln: 'technical', hold: 'technical', control: 'technical',
  timing: 'technical', precision: 'technical', accuracy: 'technical', snap: 'technical',
  snapping: 'technical', snapped: 'technical', unsnapped: 'technical', missnapped: 'technical',
  offbeat: 'technical', synced: 'technical', desynced: 'technical', offset: 'technical',
  delayed: 'technical', early: 'technical', late: 'technical', hitsound: 'technical',
  hitsounding: 'technical', whistle: 'technical', clap: 'technical', finish: 'technical',
  sample: 'technical', sampleset: 'technical', feedback: 'technical', audio: 'technical',
  sound: 'technical', metadata: 'technical', artist: 'technical', title: 'technical',
  source: 'technical', tags: 'technical', background: 'technical', preview: 'technical',
  bpm: 'technical', visual: 'technical', storyboard: 'technical', skin: 'technical',
  combo: 'technical', color: 'technical', visibility: 'technical', timestamp: 'technical',
  format: 'technical', file: 'technical', folder: 'technical', link: 'technical',
  download: 'technical', upload: 'technical',
  pattern: { color: '#fafaff', bg: 'rgba(248,248,255,0.08)', border: 'rgba(235,240,255,0.15)', category: 'pattern' },
  jack: 'pattern', trill: 'pattern', anchor: 'pattern', stream: 'pattern',
  chord: 'pattern', speed: 'pattern', burst: 'pattern', jumpstream: 'pattern',
  jumptrill: 'pattern', handstream: 'pattern', minijack: 'pattern', longjack: 'pattern',
  roll: 'pattern', staircase: 'pattern', ladder: 'pattern', cascade: 'pattern',
  splitjumptrill: 'pattern', bracket: 'pattern', hand: 'pattern', quad: 'pattern',
  glut: 'pattern', shield: 'pattern', inverse: 'pattern', grace: 'pattern',
  stamina: 'pattern', endurance: 'pattern', dump: 'pattern', difficulty: 'pattern',
  hard: 'pattern', spike: 'pattern',
  flow: { color: '#fffdf9', bg: 'rgba(255,252,248,0.08)', border: 'rgba(250,245,235,0.15)', category: 'flow' },
  bias: 'flow', imbalance: 'flow', unbalanced: 'flow', flow: 'flow',
  uneven: 'flow', transition: 'flow', pacing: 'flow', momentum: 'flow',
  rhythm: 'flow', rhythmic: 'flow', progression: 'flow', continuity: 'flow',
  cohesion: 'flow', cohesive: 'flow', fluidity: 'flow', fluid: 'flow',
  movement: 'flow', motion: 'flow', dynamic: 'flow', static: 'flow',
  spacing: 'flow', gap: 'flow', distance: 'flow', break: 'flow',
  pause: 'flow', rest: 'flow', spread: 'flow', curve: 'flow',
  contrast: 'flow',
  complex: { color: '#faffff', bg: 'rgba(248,255,255,0.08)', border: 'rgba(235,250,250,0.15)', category: 'complex' },
  tech: 'complex', technical: 'complex', complex: 'complex', tricky: 'complex',
  pattern: 'complex', difficult: 'complex', challenging: 'complex', demanding: 'complex',
  intricate: 'complex', sophisticated: 'complex', advanced: 'complex', nuanced: 'complex',
  subtle: 'complex', layered: 'complex', multifaceted: 'complex', creative: 'complex',
  constructive: { color: '#fffffa', bg: 'rgba(255,255,250,0.08)', border: 'rgba(252,252,235,0.15)', category: 'constructive' },
  suggestion: 'constructive', consider: 'constructive', try: 'constructive', idea: 'constructive',
  maybe: 'constructive', recommend: 'constructive', propose: 'constructive', alternative: 'constructive',
  option: 'constructive', possibility: 'constructive', potential: 'constructive', improvement: 'constructive',
  enhancement: 'constructive', refinement: 'constructive', adjustment: 'constructive', tweak: 'constructive',
  modification: 'constructive', change: 'constructive', remap: 'constructive', move: 'constructive',
  shift: 'constructive', replace: 'constructive', remove: 'constructive', add: 'constructive',
  delete: 'constructive', adjust: 'constructive', fix: 'constructive', correct: 'constructive',
  update: 'constructive', simplify: 'constructive', reduce: 'constructive', increase: 'constructive',
  emphasize: 'constructive', highlight: 'constructive', clarify: 'constructive', mod: 'constructive',
  modding: 'constructive', check: 'constructive', review: 'constructive', optional: 'constructive',
  recommended: 'constructive', suggested: 'constructive',
  positive: { color: '#fafffa', bg: 'rgba(248,255,248,0.08)', border: 'rgba(235,250,235,0.15)', category: 'positive' },
  clean: 'positive', good: 'positive', smooth: 'positive', nice: 'positive',
  accurate: 'positive', well: 'positive', perfect: 'positive', excellent: 'positive',
  great: 'positive', solid: 'positive', strong: 'positive', effective: 'positive',
  polished: 'positive', refined: 'positive', impressive: 'positive', enjoyable: 'positive',
  fun: 'positive', comfortable: 'positive', natural: 'positive', fitting: 'positive',
  appropriate: 'positive', balanced: 'positive', harmonious: 'positive', coherent: 'positive',
  clear: 'positive', readable: 'positive', playable: 'positive', fair: 'positive',
  reasonable: 'positive', manageable: 'positive', accessible: 'positive', intuitive: 'positive',
  logical: 'positive', sensible: 'positive', easy: 'positive', aesthetic: 'positive',
  rankable: 'positive', qualified: 'positive', quality: 'positive', finished: 'positive',
  complete: 'positive', unique: 'positive', final: 'positive', disqualified: 'positive',
  logic: { color: '#fbfffb', bg: 'rgba(250,255,250,0.08)', border: 'rgba(240,252,240,0.15)', category: 'logic' },
  intent: 'logic', emphasis: 'logic', structure: 'logic', consistent: 'logic',
  mapping: 'logic', layering: 'logic', representation: 'logic', interpretation: 'logic',
  expression: 'logic', concept: 'logic', theme: 'logic', motif: 'logic',
  consistency: 'logic', logic: 'logic', reasoning: 'logic', rationale: 'logic',
  justification: 'logic', purpose: 'logic', objective: 'logic', goal: 'logic',
  direction: 'logic', approach: 'logic', method: 'logic', technique: 'logic',
  strategy: 'logic', philosophy: 'logic', vocal: 'logic', instrumental: 'logic',
  melody: 'logic', percussion: 'logic', drum: 'logic', bass: 'logic',
  synth: 'logic', guitar: 'logic', piano: 'logic', kick: 'logic',
  snare: 'logic', hihat: 'logic', cymbal: 'logic', guidelines: 'logic',
  criteria: 'logic', rules: 'logic', rc: 'logic', intro: 'logic',
  verse: 'logic', chorus: 'logic', bridge: 'logic', outro: 'logic',
  buildup: 'logic', drop: 'logic', kiai: 'logic', section: 'logic',
  context: 'logic', style: 'logic',
  neutral: { color: '#fefefe', bg: 'rgba(250,250,250,0.05)', border: 'rgba(240,240,240,0.12)', category: 'neutral' },
  copy: 'neutral', repeat: 'neutral', same: 'neutral', redundant: 'neutral',
  repetitive: 'neutral', similar: 'neutral', identical: 'neutral', duplicate: 'neutral',
  mirrored: 'neutral', symmetrical: 'neutral', parallel: 'neutral', uniform: 'neutral',
  consistent: 'neutral', standard: 'neutral', conventional: 'neutral', typical: 'neutral',
  normal: 'neutral', regular: 'neutral', ordinary: 'neutral', common: 'neutral',
  basic: 'neutral', simple: 'neutral', straightforward: 'neutral', plain: 'neutral',
  sparse: 'neutral', mild: 'neutral', moderate: 'neutral', minor: 'neutral',
  note: 'neutral', observation: 'neutral', subjective: 'neutral', preference: 'neutral',
  opinion: 'neutral', personal: 'neutral', generic: 'neutral', previous: 'neutral',
  current: 'neutral', compared: 'neutral', reference: 'neutral', relative: 'neutral',
  conditional: 'neutral', situational: 'neutral', placeholder: 'neutral', temporary: 'neutral',
  version: 'neutral', draft: 'neutral', wip: 'neutral',
  getColors(tag) {
...
`;
        ...
        static renderAnalysisResults(container, data) {
                const { grammar, readability, sentiment, passive, repetition, fillers } = data;
                ...
                static async checkForNewNotes() {
                        ...
                        GM_xmlhttpRequest({
                                ...
                                onload: (response) => {
                                        if (response.status >= 200 && response.status < 300) {
                                                try {
                                                        const serverNotes = JSON.parse(response.responseText);
                        ...
                        return new Promise((resolve) => {
                                ...
                                GM_xmlhttpRequest({
                                        ...
                                        onload: (response) => {
                                                if (response.status >= 200 && response.status < 300) {
                                                        try {
                                                                this.notes = JSON.parse(response.responseText);
